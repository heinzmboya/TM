...
<body>
    <div class="bg-white text-gray-900">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <header>
                    ...
                    <nav class="-mx-3 flex flex-1 justify-end gap-x-3">
                        ...
                        @else
                        <a href="{{ route('login') }}">
                            <button type="button" class="py-3 px-4 text-sm font-medium rounded-md bg-black text-white hover:bg-primary-700 disabled:opacity-50 disabled:pointer-events-none">
                                Log in
                            </button>
                        ...
                        <a href="{{ route('get-started') }}">
                            <button type="button" class="hidden md:block py-3 px-4 text-sm font-medium rounded-md bg-primary-600 text-white hover:bg-primary-700 disabled:opacity-50 disabled:pointer-events-none">
                                Get started
                            </button>
        ...
        <div class="min-h-screen ">
            <div class="">
                <main class="mt-6 md:flex overflow-x-hidden">
                    <section class="md:w-1/2  md:px-20 mx-5">
                        <p class="font-bold text-5xl md:text-[72px]">
                            Simplify Your Workflow with TaskManager
                        </p>

                        <section class="md:hidden relative mt-16 h-[450px] w-full">
                            <img class="w-full h-full -right-20 absolute object-contain scale-[2.8]" src="/images/group.png" alt="Logo" />
                        </section>
                ...
                <footer class="p-6 text-sm md:px-24 text-gray-500 font-medium">
                    &#169; TaskManager 2024
                </footer>
            </div>
        </div>
